...
const failures = [];
const required = ['compose/devops/docker-compose.yml','compose/middleware/docker-compose.yml','compose/observability/docker-compose.yml','compose/application/docker-compose.yml','config/maven/settings.xml','config/mongodb/mongod.conf','scripts/bootstrap/bootstrap.sh','scripts/init/init-mysql.sh','scripts/init/init-mongodb.sh','scripts/init/init-nacos.sh','scripts/ci/maven-build.sh','scripts/deploy/deploy-services.sh','README.md','README.en-US.md'];
