...
public class S3StorageProvider implements StorageProvider {
    ...
    public S3StorageProvider(StorageProperties.StorageProvider config) {
        this.config = config;
    ...
    public boolean exists(String bucketName, String objectKey) {
        try {
            ...
            throw toStorageException("Failed to check S3 object exists: " + objectKey, ex);
        }
    }
    ...
    public boolean bucketExists(String bucketName) {
        try {
            ...
            throw toStorageException("Failed to check S3 bucket exists: " + bucketName, ex);
        }
    }
    ...
    public ObjectInfo stat(DownloadObjectRequest request) {
        ...
        try {
            ...
            throw toStorageException("Failed to stat S3 object: " + request.getObjectKey(), ex);
        }
    }
    ...
    public UploadResult upload(UploadObjectRequest request) {
        ...
        try {
            ...
            throw toStorageException("Failed to upload S3 object: " + request.getObjectKey(), ex);
        }
    }
    ...
    public InputStream download(DownloadObjectRequest request) {
        ...
        try {
            ...
            throw toStorageException("Failed to download S3 object: " + request.getObjectKey(), ex);
        }
    }
    ...
    public DeleteResult delete(DeleteObjectRequest request) {
        ...
        try {
            ...
            throw toStorageException("Failed to delete S3 object: " + request.getObjectKey(), ex);
        }
    }
    ...
    public ListObjectsResult list(ListObjectsRequest request) {
        ...
        try {
            ...
            throw toStorageException("Failed to list S3 objects by prefix: " + request.getPrefix(), ex);
        }
    }
    ...
    public PresignedUrlResult generatePresignedUrl(PresignedUrlRequest request) {
        ...
        try {
            ...
            throw toStorageException("Failed to generate S3 presigned url: " + request.getObjectKey(), ex);
        }
    }
    ...
    public InitiateMultipartUploadResult initiateMultipartUpload(InitiateMultipartUploadRequest request) {
        ...
        try {
            ...
            throw toStorageException("Failed to initiate S3 multipart upload: " + request.getObjectKey(), ex);
        }
    }
    ...
    public UploadPartResult prepareUploadPart(UploadPartRequest request) {
        ...
        try {
            ...
            throw toStorageException("Failed to prepare S3 multipart upload part: " + request.getObjectKey(), ex);
        }
    }
    ...
    public CompleteMultipartUploadResult completeMultipartUpload(
        ...
        try {
            ...
            throw toStorageException("Failed to complete S3 multipart upload: " + request.getObjectKey(), ex);
        }
    }
    ...
    public AbortMultipartUploadResult abortMultipartUpload(AbortMultipartUploadRequest request) {
        ...
        try {
            ...
            throw toStorageException("Failed to abort S3 multipart upload: " + request.getObjectKey(), ex);
        }
    }
    ...
    public void setPublicReadAcl(String objectKey) {
        try {
            ...
            throw toStorageException("Failed to set S3 public read acl: " + objectKey, ex);
        }
    }
     ...
     * 并转换为 AWS S3 SDK 所需的 {@link ObjectMetadata} 对象。</p>
     *
     ...
     * 并转换为 AWS S3 SDK 所需的 {@link ObjectMetadata} 对象。分片上传不需要预设内容长度。</p>
     *
     ...
     *
     * <p>AWS S3 完成分片上传接口要求提供按分片号升序排列的 PartETag 列表，
     * 此方法负责转换和排序。</p>
     *
