...
@Indexed
@Component
public class StorageQuickstartRunner implements CommandLineRunner {

    private static final Logger log = LoggerFactory.getLogger(StorageQuickstartRunner.class);

    private static final String OBJECT_KEY = "quickstarts/hello.txt";
    private static final String COPY_KEY = "quickstarts/copy/hello-copy.txt";
    private static final String MOVE_SOURCE_KEY = "quickstarts/move/hello-move-source.txt";
    private static final String MOVE_TARGET_KEY = "quickstarts/move/hello-move-target.txt";
    private static final String BATCH_KEY_A = "quickstarts/batch/a.txt";
    private static final String BATCH_KEY_B = "quickstarts/batch/b.txt";
    private static final String MULTIPART_KEY = "quickstarts/multipart/demo.bin";

    private final StorageTemplate storageTemplate;

    public StorageQuickstartRunner(StorageTemplate storageTemplate) {
    ...
    public void run(String... args) {
        ...
        try (InputStream inputStream = storageTemplate.download(DownloadObjectRequest.builder()
            ...
            throw new IllegalStateException("Failed to download quickstart object", ex);
        }
        ...
        log.info("Peach store quickstart finished.");
    ...
    private void runMoveQuickstart() {
        storageTemplate.upload(UploadObjectRequest.builder()
                .objectKey(MOVE_SOURCE_KEY)
                .content(UploadContent.of("move quickstart", StandardCharsets.UTF_8))
                .contentType(StorageContentType.TEXT_PLAIN_UTF8)
                .build());
    ...
    private void runBatchDeleteQuickstart() {
        storageTemplate.upload(UploadObjectRequest.builder()
