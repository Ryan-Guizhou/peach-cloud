...
public class TemplateManager {
    ...
    public TemplateManager(TemplateRenderer renderer, List<TemplateResolver> extraResolvers) {
        ...
        if (extraResolvers != null) resolvers.addAll(extraResolvers);
        ...
        while (it.hasNext()) resolvers.add(it.next());
    ...
    public String renderById(String templateId, Map<String,Object> data) {
        ...
        if (path == null) throw new IllegalArgumentException("template id not found: " + templateId);
