package com.peach.redission.config;
...
import static com.peach.redission.config.DelayQueueProperties.PREFIX;

/**
 * @Author Mr Shu
 * @Version 1.0.0
 * @CreateTime 2025/12/17 17:30
 * @Description 延时队列属性配置类
...
public class DelayQueueProperties {
     ...
     * 死信队列消息保留时间（小时）
     */
    private Integer deadLetterMessageRetentionHours = 168;
}