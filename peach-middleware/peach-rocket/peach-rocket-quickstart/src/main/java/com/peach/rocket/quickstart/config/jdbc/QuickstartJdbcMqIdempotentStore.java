package com.peach.rocket.quickstart.config.jdbc;
...
/**
 * QuickstartJdbcMQ幂等存储。
 *
 * @Author Mr Shu
 * @Version 1.0.0
 * @CreateTime 2026/6/26
 */
public class QuickstartJdbcMqIdempotentStore implements MqIdempotentStore {
    ...
    public QuickstartJdbcMqIdempotentStore(JdbcTemplate jdbcTemplate) {
