...
public class UserContextProperties {
    ...
    private List<SatokenEndpointRule> publicEndpoints = Arrays.asList(
            ...
            SatokenEndpointRule.of("POST", "/auth/login"),
            SatokenEndpointRule.of("POST", "/auth/logout"),
            SatokenEndpointRule.of("POST", "/auth/register"),
            SatokenEndpointRule.of("POST", "/auth/forget"),
            SatokenEndpointRule.of("POST", "/auth/reset"),
            SatokenEndpointRule.of("POST", "/auth/getCaptcha"),
            SatokenEndpointRule.of("POST", "/auth/checkCaptcha"),
            SatokenEndpointRule.of("POST", "/auth/init"),
            SatokenEndpointRule.of("GET", "/auth/rsa-public-key"),
            SatokenEndpointRule.of("GET", "/setting/external/valueSet/item/list/**"),
