...
public final class PeachOpenfeignConstants {
    ...
    public static final List<String> DEFAULT_RETRY_READ_METHODS = Collections.unmodifiableList(Arrays.asList(
            "GET",
            "HEAD"
    ));

    public static final List<Integer> DEFAULT_RETRYABLE_STATUSES = Collections.unmodifiableList(Arrays.asList(
            429,
            503,
            504
    ));

    public static final List<String> DEFAULT_RETRYABLE_EXCEPTIONS = Collections.unmodifiableList(Arrays.asList(
    ...
    public static final List<String> DEFAULT_PRODUCTION_PROFILES = Collections.unmodifiableList(Arrays.asList(
            "prod",
            "production",
            "docker"
    ));
