---
name: ui-ux-pro-max
description: Provides searchable UI/UX design guidance for layouts, interaction, accessibility, responsive behavior, visual systems, and charts. Use when designing, implementing, improving, or reviewing user interfaces and user experience.
---
# ui-ux-pro-max
...
python3 .cursor/skills/ui-ux-pro-max/scripts/search.py "enterprise tableview density permission" --stack javafx
```
