---
name: banner-design
description: "Design banners for social media, ads, website heroes, creative assets, and print. Use when creating or reviewing banner layouts, art direction, typography, responsive sizes, accessible contrast, or export-ready visual assets. Coordinates ui-ux-pro-max, design-system, brand, and available image or browser tools."
...
1. **Create HTML/CSS banner** using `ui-ux-pro-max` and `design-system`
...
3. **Compress oversized output** with an already available image tool; do not install system packages without user approval.
4. If screenshot tooling is unavailable, deliver the verified HTML/CSS and state that PNG export was not run.
...
- Exported PNG preview when an image-reading capability is available
