...
public final class MultiLanguage {
    ...
    static final String DEFAULT_COMMON_PATH = "i18n.common";

    static final String DEFAULT_RESPONE_PATH = "i18n.response";

    static final String DEFAULT_EXCEPTION_PATH = "i18n.exception";
