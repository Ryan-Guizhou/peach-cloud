...
public class BaseDO implements Serializable {
    ...
    public <E extends BaseDO> E copyFromMap(Map<String, ?> source) {
     ...
     */
    @SuppressWarnings("unchecked")
    public <E extends BaseDO> E deepClone() {
        try {
     ...
     */
    @SuppressWarnings("unchecked")
    public <E extends BaseDO> E setEntityId() {
        try {
    ...
    private static Field getIdField(Class<?> clazz) {
        if (clazz == null || clazz == Object.class || clazz == BaseDO.class) {
